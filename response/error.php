...
<body bgcolor="#f9f7f5">
    ...
    <h2>ERROR. Your request could not be processed. Please go back to the form and try again.</h2>
    <h3>If you have any questions, please contact the Reference Desk:
		Tel. 718-636-3704,  Fax. 718-399-4220.</h3>
        <p>Thanks! </p>
	<!-- InstanceEndEditable -->    
    </div>
